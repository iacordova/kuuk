...
echo html::stylesheet(url::file_loc('css').'themes/kuuk/css/foundation.min', '', TRUE);
echo html::stylesheet(url::file_loc('css').'themes/kuuk/css/kuuk', '', TRUE);
...
echo html::script(url::file_loc('js').'themes/kuuk/js/foundation.min', TRUE);
?>
		...
		<div class="fixed">
			...
			<nav class="top-bar" data-topbar="" role="navigation">
				...
				<section class="top-bar-section">
					...
					<?php //echo $header_nav; //ISSUE WITH JS ?>
...
<div id="ushahidi_site_name" class="ui-corner-all row">
...
<div class="row">
<?php if ($message): ?>
	<div class="<?php echo $message_class; ?> ui-corner-all large-12 columns">&#8226;&nbsp;<?php echo $message; ?></div>
<?php endif; ?>
</div>

<div class="row">
<?php if ($form_error): ?>
	<div class="login_error ui-corner-all large-12 columns">
...
<div class="row">
	...
	<div class="large-6 columns">
		<div id="create_account" class="ui-corner-all large-6 columns">

...
<?php if ($site_message != ''): ?>
	<div class="green-box large-12 columns">
	...
	<div class="large-8 columns">
		...
		<div class="filters">
			<dl class="sub-nav">
				...
				<dd><a id="media_0" class="active" href="#"><?php echo Kohana::lang('ui_main.all'); ?></a></dd>
				<dd><a id="media_4" href="#"><?php echo Kohana::lang('ui_main.news'); ?></a></dd>
				<dd><a id="media_1" href="#"><?php echo Kohana::lang('ui_main.pictures'); ?></a></dd>
				<dd><a id="media_2" href="#"><?php echo Kohana::lang('ui_main.video'); ?></a></dd>
			</dl>

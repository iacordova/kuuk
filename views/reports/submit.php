<div id="content" class="row">
	<div class="large-12 columns">
		...
		<?php if ($site_submit_report_message != ''): ?>
			<div class="green-box">
				<h5><?php echo $site_submit_report_message; ?></h5>
			</div>
		<?php endif; ?>
		...
		<div class="row">
			...
			<div class="large-6 columns">
				...
				<div class="report_row">
					...
					<?php print form::textarea('incident_description', $form['incident_description'], ' rows="10" class="textarea" ') ?>
				</div>
			...
			<div class="large-6 columns">
				...
				<div class="report_row">
					<input name="submit" type="submit" value="<?php echo Kohana::lang('ui_main.reports_btn_submit'); ?>" class="button success expand" /> 
				</div>
			</div>
		</div>
